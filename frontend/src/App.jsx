...
import GestionAcademica from './pages/GestionAcademica.jsx'
    ...
    <AuthProvider>
      <Routes>
        ...
        <Route
          path="/registro"
          element={
            <Guard roles={['registro']}>
              <DashboardRegistro />
            </Guard>
          }
        />
        <Route
          path="/registro/configuracion"
          element={
            <Guard roles={['registro']}>
              <GestionAcademica />
            </Guard>
        ...
        <Route
          ...
          element={
            <Guard roles={['estudiante', 'profesor', 'registro']}>
              <SetupBiometrico />
            </Guard>
          }
        />
